...
Tile.prototype.getTileAbove = function () {
    return this.map.getTileAt(this.x, this.y - 1);
};
...
Tile.prototype.getTileLeft = function () {
    return this.map.getTileAt(this.x - 1, this.y);
};
...
Tile.prototype.tag = function (tag) {
    this.tagged = tag;
};

Tile.prototype.tagged = function () {
    return this.tagged != undefined;
};
